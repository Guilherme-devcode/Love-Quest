...
{for(var i = 0, len = gdjs.Level_326Code.GDDuckObjects3.length ;i < len;++i) {
    ...
    gdjs.Level_326Code.GDDuckArtworkObjects3[i].setHeight(115);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects3[i].setWidth(120);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects3[i].getBehavior("Tween").addObjectWidthTween("Squash Jump", 120, "linear", 80, false);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects3.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects3[i].getBehavior("Tween").addObjectHeightTween("Stretch Jump", 120, "linear", 80, false);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckObjects3.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects2[i].setHeight(40);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects2[i].setWidth(90);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects2[i].getBehavior("Tween").addObjectHeightTween("Stretch", 120, "linear", 80, false);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects2.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects2[i].getBehavior("Tween").addObjectWidthTween("Squash", 120, "linear", 80, false);
}
}}
...
{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects1[i].getBehavior("Tween").addObjectHeightTween("Stretch Air", 125, "linear", 80, false);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects1[i].getBehavior("Tween").addObjectWidthTween("Squash Air", 110, "linear", 80, false);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("DuckArtwork"), gdjs.Level_326Code.GDDuckArtworkObjects1);
{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects1[i].getBehavior("Resizable").setHeight(80);
}
}{for(var i = 0, len = gdjs.Level_326Code.GDDuckArtworkObjects1.length ;i < len;++i) {
    gdjs.Level_326Code.GDDuckArtworkObjects1[i].getBehavior("Resizable").setWidth(80);
}
}}
